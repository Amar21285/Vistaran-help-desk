...
import { InventoryItem, Vendor, Role, ReceivingChallan, Invoice, User, PurchaseOrder, AssetStatus, AssetTransferRecord } from '../types';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                {activeTab === 'attendance' && <AttendanceManagement users={users} />}
            </div>
