...
const Logo: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className = "h-10", style }) => (
    <div className={`flex items-center justify-center ${className}`} style={{ ...style, minWidth: 'max-content' }}>
        <svg viewBox="0 0 100 100" className="h-full w-auto flex-shrink-0 z-10" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex items-baseline -ml-1.5 z-20" style={{ fontFamily: "Georgia, serif", color: "#2c3e50", fontWeight: "bold", fontSize: '1.4em' }}>
            <span>v</span>
