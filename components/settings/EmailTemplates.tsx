...
const TEMPLATE_NAMES: Record<string, string> = {
  ...
  receivingChallan: "Material Inward (Challan Acknowledgement)",
  outwardInvoice: "Material Outward (Issue Notification)",
};
...
const PLACEHOLDERS: Record<string, string[]> = {
  ...
  receivingChallan: ["challan.id", "challan.date", "challan.notes", "vendor.name", "receiver.name", "items.table"],
  outwardInvoice: ["invoice.id", "invoice.date", "invoice.notes", "invoice.deliveryMethod", "vendor.name", "issuer.name", "items.table"],
};
