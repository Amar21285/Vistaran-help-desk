        ...
        return (
            <div id={`${idPrefix}printable-label-content`} style={{ ...containerStyle, flexDirection: 'row', gap: 0, padding: 0 }} className={isHighContrast ? 'high-contrast-mode' : ''}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
                    ...
                    <div style={{ height: '18%', borderBottom: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', boxSizing: 'border-box', overflow: 'hidden' }}>
                        <div style={{ flex: 1, padding: `${0.8 * baseScale}mm ${1.5 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <span style={{ fontSize: `${1.4 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1 }}>Asset ID</span>
                            <span style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, marginTop: `${0.2 * baseScale}mm`, lineHeight: 1, wordBreak: 'break-all' }}>{item.id}</span>
                        </div>
                        <div style={{ width: '35%', padding: `${0.8 * baseScale}mm ${1.5 * baseScale}mm`, borderLeft: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'right', overflow: 'hidden' }}>
                            <span style={{ fontSize: `${1.4 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1 }}>Verified</span>
                            <span style={{ fontSize: `${2.6 * baseScale}mm`, fontWeight: 900, marginTop: `${0.2 * baseScale}mm`, lineHeight: 1 }}>{new Date().toLocaleDateString()}</span>
                        </div>
                    </div>

                    {/* Row 2: Designation */}
                    <div style={{ height: '26%', borderBottom: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${0.8 * baseScale}mm ${1.5 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center', boxSizing: 'border-box', overflow: 'hidden' }}>
                        <span style={{ fontSize: `${1.4 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1 }}>Designation</span>
                        <p style={{ fontSize: `${3.4 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: `${0.2 * baseScale}mm 0 0 0`, lineHeight: 1.2, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', wordBreak: 'break-word', maxHeight: `${9 * baseScale}mm` }}>{item.name}</p>
                    </div>
                    ...
                    <div style={{ height: '28%', borderBottom: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', boxSizing: 'border-box', overflow: 'hidden' }}>
                        <div style={{ flex: 1, padding: `${0.8 * baseScale}mm ${1.5 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <div style={{ border: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${0.8 * baseScale}mm`, height: '90%', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflow: 'hidden' }}>
