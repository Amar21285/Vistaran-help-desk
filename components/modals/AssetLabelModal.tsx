...
export const PrintableLabel: React.FC<{
    ...
    if (template === 'official') {
        return (
            <div id={`${idPrefix}printable-label-content`} style={{ ...containerStyle, flexDirection: 'column', gap: 0, padding: 0 }} className={`${isHighContrast ? 'high-contrast-mode' : ''} label-content`}>
                {/* Header Row: Logo | Asset ID | Verified */}
                <div style={{ display: 'flex', alignItems: 'center', borderBottom: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.5 * baseScale}mm` }}>
                    <div style={{ width: '25%' }}>
                        <Logo className={isDarkMode ? "brightness-200" : "grayscale brightness-0"} style={{ height: `${5 * baseScale}mm`, width: 'auto' }} />
                    </div>
                    <div style={{ flex: 1, borderLeft: `${0.3 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, paddingLeft: `${3 * baseScale}mm` }}>
                        <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 800, textTransform: 'uppercase', opacity: 0.7, display: 'block' }}>Asset ID</span>
                        <span style={{ fontSize: `${4 * baseScale}mm`, fontWeight: 900, display: 'block', marginTop: '-0.5mm' }}>{item.id}</span>
                    </div>
                    <div style={{ width: '20%', textAlign: 'right' }}>
                        <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 800, textTransform: 'uppercase', opacity: 0.7, display: 'block' }}>Verified</span>
                        <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, display: 'block', marginTop: '-0.5mm' }}>{new Date().toLocaleDateString()}</span>
                    </div>
                </div>

                {/* Designation Row */}
                <div style={{ borderBottom: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.5 * baseScale}mm` }}>
                    <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 800, textTransform: 'uppercase', opacity: 0.7, display: 'block' }}>Designation</span>
                ...
                <div style={{ flex: 1, display: 'flex' }}>
                    {/* QR Section */}
                    <div style={{ width: '35%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRight: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1 * baseScale}mm` }}>
                        <img src={qrCodeUrl} style={{ width: '75%', height: 'auto', imageRendering: 'pixelated', filter: isDarkMode ? 'invert(1)' : 'none' }} alt="QR" />
                        <p style={{ fontSize: `${1.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', marginTop: `${1 * baseScale}mm`, textAlign: 'center', lineHeight: 1.2, width: '90%' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: `${2 * baseScale}mm`, gap: `${2 * baseScale}mm`, justifyContent: 'center' }}>
                        <div style={{ display: 'flex', gap: `${2 * baseScale}mm` }}>
                            <div style={{ flex: 1, border: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.5 * baseScale}mm` }}>
                                <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, opacity: 0.6, display: 'block', textTransform: 'uppercase' }}>Category</span>
                            ...
                            <div style={{ flex: 1, border: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.5 * baseScale}mm` }}>
                                <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, opacity: 0.6, display: 'block', textTransform: 'uppercase' }}>Bin / Rack</span>
                ...
                <div style={{ borderTop: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.5 * baseScale}mm`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
    ...
    if (template === 'industrial') {
        return (
            <div id={`${idPrefix}printable-label-content`} style={{ ...containerStyle, flexDirection: 'column', padding: 0 }} className={`${isHighContrast ? 'high-contrast-mode' : ''} label-content`}>
                <div style={{ height: '22%', borderBottom: `${0.5 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', alignItems: 'center', padding: `0 ${3 * baseScale}mm`, backgroundColor: isDarkMode ? '#111' : '#f4f4f4' }}>
                    <Logo className={isDarkMode ? "brightness-200" : "grayscale brightness-0"} style={{ height: '60%', width: 'auto' }} />
                    <div style={{ flex: 1, textAlign: 'right' }}>
                        <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 800, textTransform: 'uppercase', opacity: 0.6, display: 'block' }}>System ID</span>
                        <span style={{ fontSize: `${4.2 * baseScale}mm`, fontWeight: 900, display: 'block', marginTop: '-0.5mm' }}>{item.id}</span>
                    </div>
                </div>
                <div style={{ flex: 1, display: 'flex' }}>
                    <div style={{ width: '30%', borderRight: `${0.5 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: `${2 * baseScale}mm` }}>
                        <img src={qrCodeUrl} style={{ width: '100%', height: 'auto', imageRendering: 'pixelated', filter: isDarkMode ? 'invert(1)' : 'none' }} alt="QR" />
                    </div>
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                        <div style={{ padding: `${2.5 * baseScale}mm`, flex: 1 }}>
                            <span style={{ fontSize: `${1.6 * baseScale}mm`, fontWeight: 800, textTransform: 'uppercase', opacity: 0.5 }}>Asset Description</span>
                            <p style={{ fontSize: `${4 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: `${0.5 * baseScale}mm 0`, lineHeight: 1.1 }}>{item.brand} {item.name}</p>
                            <div style={{ display: 'flex', gap: `${2 * baseScale}mm`, marginTop: `${2 * baseScale}mm` }}>
                                <div style={{ flex: 1, border: `${0.3 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.2 * baseScale}mm`, backgroundColor: isDarkMode ? '#222' : '#fff' }}>
                                ...
                                <div style={{ flex: 1, border: `${0.3 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1.2 * baseScale}mm`, backgroundColor: isDarkMode ? '#222' : '#fff' }}>
                                    ...
                                    <span style={{ fontSize: `${2.8 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase' }}>{item.location || 'N/A'}</span>
                                </div>
                            </div>
                        </div>
                        <div style={{ height: '32%', borderTop: `${0.5 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: `${1 * baseScale}mm` }}>
                            <svg ref={barcodeRef} style={{ width: '90%', height: 'auto', filter: isDarkMode ? 'invert(1)' : 'none' }}></svg>
                        </div>
                    </div>
                </div>
            </div>
    ...
    if (template === 'compact') {
        return (
            <div id={`${idPrefix}printable-label-content`} style={{ ...containerStyle, flexDirection: 'column', padding: `${1.5 * baseScale}mm`, gap: `${1 * baseScale}mm` }} className={`${isHighContrast ? 'high-contrast-mode' : ''} label-content`}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: `${0.2 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, paddingBottom: `${1 * baseScale}mm` }}>
                    <Logo className={isDarkMode ? "brightness-200" : "grayscale brightness-0"} style={{ height: `${4 * baseScale}mm`, width: 'auto' }} />
                    <span style={{ fontSize: `${3.5 * baseScale}mm`, fontWeight: 900, fontFamily: 'monospace' }}>{item.id.slice(-8)}</span>
                </div>
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: `${2 * baseScale}mm` }}>
                    <img src={qrCodeUrl} style={{ width: '40%', height: 'auto', filter: isDarkMode ? 'invert(1)' : 'none' }} alt="QR" />
                    <div style={{ flex: 1, overflow: 'hidden' }}>
                        <p style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.name}</p>
                        <p style={{ fontSize: `${2 * baseScale}mm`, fontWeight: 800, opacity: 0.6, margin: 0 }}>{item.category}</p>
                        <p style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 700, opacity: 0.5, margin: 0, fontFamily: 'monospace' }}>{item.id}</p>
                    </div>
                </div>
                <div style={{ borderTop: `${0.2 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, paddingTop: `${1 * baseScale}mm` }}>
                    <svg ref={barcodeRef} style={{ width: '100%', height: `${6 * baseScale}mm`, filter: isDarkMode ? 'invert(1)' : 'none' }}></svg>
                </div>
            </div>
        );
    }
    ...
    if (template === 'modern') {
        return (
            <div id={`${idPrefix}printable-label-content`} style={{ ...containerStyle, flexDirection: 'row', padding: 0 }} className={`${isHighContrast ? 'high-contrast-mode' : ''} label-content`}>
                <div style={{ width: '38%', height: '100%', borderRight: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: `${3 * baseScale}mm`, backgroundColor: isDarkMode ? '#111' : '#f9f9f9' }}>
                    <img src={qrCodeUrl} style={{ width: '85%', height: 'auto', filter: isDarkMode ? 'invert(1)' : 'none' }} alt="QR" />
                    <div style={{ marginTop: `${3 * baseScale}mm`, textAlign: 'center' }}>
                        <span style={{ fontSize: `${4 * baseScale}mm`, fontWeight: 900, letterSpacing: '0.5px', fontFamily: 'monospace' }}>{item.id}</span>
                    </div>
                </div>
                <div style={{ flex: 1, padding: `${4 * baseScale}mm`, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ flex: 1 }}>
                        <Logo className={isDarkMode ? "brightness-200" : "grayscale brightness-0"} style={{ height: `${5 * baseScale}mm`, width: 'auto', marginBottom: `${3 * baseScale}mm` }} />
                        <h2 style={{ fontSize: `${5 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: 0, lineHeight: 1.1 }}>{item.name}</h2>
                        <div style={{ marginTop: `${2 * baseScale}mm`, display: 'flex', gap: `${2 * baseScale}mm` }}>
                            <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 700, textTransform: 'uppercase', opacity: 0.6 }}>{item.category}</span>
                            <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 700, textTransform: 'uppercase', opacity: 0.6 }}>•</span>
                            <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 700, textTransform: 'uppercase', opacity: 0.6 }}>{item.location || 'N/A'}</span>
                        </div>
                    </div>
                    <div style={{ borderTop: `${0.2 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, paddingTop: `${3 * baseScale}mm` }}>
                        <svg ref={barcodeRef} style={{ width: '100%', height: `${8 * baseScale}mm`, filter: isDarkMode ? 'invert(1)' : 'none' }}></svg>
                    </div>
                </div>
            </div>
        );
    ...
    if (template === 'strip') {
        return (
            <div id={`${idPrefix}printable-label-content`} style={{ ...containerStyle, flexDirection: 'row', alignItems: 'center', padding: `0 ${2 * baseScale}mm`, gap: `${3 * baseScale}mm` }} className={`${isHighContrast ? 'high-contrast-mode' : ''} label-content`}>
                <div style={{ height: '80%', display: 'flex', alignItems: 'center' }}>
                    <img src={qrCodeUrl} style={{ height: '100%', width: 'auto', filter: isDarkMode ? 'invert(1)' : 'none' }} alt="QR" />
                </div>
                <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <p style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, margin: 0, textTransform: 'uppercase', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.name}</p>
                    <div style={{ display: 'flex', gap: `${2 * baseScale}mm`, alignItems: 'center' }}>
                        <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 800, opacity: 0.6 }}>{item.id}</span>
                        <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 800, opacity: 0.6 }}>|</span>
                        <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 800, opacity: 0.6 }}>{item.category}</span>
                    </div>
                </div>
                <div style={{ width: '30%', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'center' }}>
                    <svg ref={barcodeRef} style={{ width: '100%', height: `${10 * baseScale}mm`, filter: isDarkMode ? 'invert(1)' : 'none' }}></svg>
                </div>
            </div>
        );
    }
                ...
                <head>
                    ...
                    <style>
                        ...
                        * { box-sizing: border-box !important; -webkit-print-color-adjust: exact !important; }
                        ...
                        #modal-printable-label-content { width: ${labelWidth}mm !important; height: ${labelHeight}mm !important; transform: rotate(0deg) !important; transform-origin: center center !important; }
                        .high-contrast-mode { filter: contrast(100) grayscale(1) !important; }
                        .label-content { transform: rotate(0deg) !important; }
                    </style>
                </head>
                <body>
