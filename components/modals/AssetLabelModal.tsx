...
export const SIZE_PRESETS = [
    ...
    { name: 'Small (50x25mm)', width: 50, height: 25 },
...
export const PrintableLabel: React.FC<{
    ...
    idPrefix?: string;
}> = ({ item, labelWidth, labelHeight, rotation, template, isHighContrast, isDarkMode = false, qrCodeUrl, barcodeWidthScale, barcodeHeightScale, idPrefix = "" }) => {
        ...
        return (
            <div id={`${idPrefix}printable-label-content`} style={{...containerStyle, flexDirection: 'row', gap: 0, padding: 0 }} className={isHighContrast ? 'high-contrast-mode' : ''}>
                ...
                <div style={{ width: '35%', borderRight: `${0.8 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', padding: `${2 * baseScale}mm 0`, boxSizing: 'border-box' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', padding: `0 ${2 * baseScale}mm` }}>
                    ...
                    <div style={{ padding: `0 ${1 * baseScale}mm`, textAlign: 'center' }}>
                        <p style={{ fontSize: `${1.6 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: 0, lineHeight: 1.2 }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
                    ...
                    <div style={{ height: '20%', borderBottom: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', boxSizing: 'border-box' }}>
                        <div style={{ flex: 1, padding: `${1 * baseScale}mm ${2 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>Asset ID</span>
                            <span style={{ fontSize: `${3.8 * baseScale}mm`, fontWeight: 900, marginTop: `${0.5 * baseScale}mm`, lineHeight: 1.2, wordBreak: 'break-all' }}>{item.id}</span>
                        </div>
                        <div style={{ width: '35%', padding: `${1 * baseScale}mm ${2 * baseScale}mm`, borderLeft: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'right' }}>
                            <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>Verified</span>
                            <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, marginTop: `${0.5 * baseScale}mm`, lineHeight: 1.2 }}>{new Date().toLocaleDateString()}</span>
                        </div>
                    </div>

                    {/* Row 2: Designation */}
                    <div style={{ height: '22%', borderBottom: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1 * baseScale}mm ${2 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center', boxSizing: 'border-box' }}>
                        <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>Designation</span>
                        <p style={{ fontSize: `${4.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: `${0.5 * baseScale}mm 0 0 0`, lineHeight: 1.2, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>{item.name}</p>
                    </div>

                    {/* Row 3: Category & Bin/Rack */}
                    <div style={{ height: '28%', borderBottom: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', boxSizing: 'border-box' }}>
                        <div style={{ flex: 1, padding: `${1 * baseScale}mm ${2 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <div style={{ border: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1 * baseScale}mm`, height: '95%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <span style={{ fontSize: `${1.6 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>Category</span>
                                <span style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', marginTop: `${0.5 * baseScale}mm`, lineHeight: 1.2, whiteSpace: 'nowrap' }}>{item.category}</span>
                            </div>
                        </div>
                        <div style={{ flex: 1, padding: `${1 * baseScale}mm ${2 * baseScale}mm`, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <div style={{ border: `${0.4 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1 * baseScale}mm`, height: '95%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <span style={{ fontSize: `${1.6 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>Bin / Rack</span>
                                <span style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', marginTop: `${0.5 * baseScale}mm`, lineHeight: 1.2, whiteSpace: 'nowrap' }}>{item.location || 'N/A'}</span>
                            </div>
                        </div>
                    </div>

                    {/* Row 4: Barcode */}
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: `${1 * baseScale}mm`, boxSizing: 'border-box', overflow: 'hidden' }}>
                        ...
                        <span style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, fontFamily: 'monospace', letterSpacing: `${0.8 * baseScale}mm`, marginTop: `${0.5 * baseScale}mm`, color: isDarkMode ? '#fff' : '#000', lineHeight: 1.2 }}>{item.id}</span>
                    </div>
                </div>
            </div>
        );
            ...
            <div id={`${idPrefix}printable-label-content`} style={{...containerStyle, flexDirection: 'column', padding: 0 }} className={isHighContrast ? 'high-contrast-mode' : ''}>
                <div style={{ height: '22%', borderBottom: `${0.8 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, display: 'flex', alignItems: 'center', padding: `0 ${4 * baseScale}mm`, backgroundColor: isDarkMode ? '#111' : '#f4f4f4', boxSizing: 'border-box' }}>
                    ...
                    <div style={{ flex: 1, textAlign: 'right', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%' }}>
                        <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', height: '40%', lineHeight: 1.2 }}>System ID</span>
                        <span style={{ fontSize: `${4.5 * baseScale}mm`, fontWeight: 900, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', height: '60%', lineHeight: 1.2 }}>{item.id}</span>
                    </div>
                </div>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
                        <div style={{ padding: `${2 * baseScale}mm ${3 * baseScale}mm`, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <span style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', display: 'flex', alignItems: 'center', height: '30%', lineHeight: 1.2 }}>Asset Description</span>
                                <div style={{ height: '70%', display: 'flex', alignItems: 'center' }}>
                                    <p style={{ fontSize: `${4.5 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: 0, lineHeight: 1.2, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', wordBreak: 'break-word' }}>{item.brand} {item.name}</p>
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: `${3 * baseScale}mm`, height: '45%' }}>
                                <div style={{ flex: 1, border: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1 * baseScale}mm ${1.5 * baseScale}mm`, backgroundColor: isDarkMode ? '#222' : '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', boxSizing: 'border-box' }}>
                                    <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, display: 'flex', alignItems: 'center', height: '40%', lineHeight: 1.2 }}>Type</span>
                                    <span style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', display: 'flex', alignItems: 'center', height: '60%', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', lineHeight: 1.2 }}>{item.category}</span>
                                </div>
                                <div style={{ flex: 1, border: `${0.6 * baseScale}mm solid ${isDarkMode ? '#fff' : '#000'}`, padding: `${1 * baseScale}mm ${1.5 * baseScale}mm`, backgroundColor: isDarkMode ? '#222' : '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', boxSizing: 'border-box' }}>
                                    <span style={{ fontSize: `${1.8 * baseScale}mm`, fontWeight: 900, display: 'flex', alignItems: 'center', height: '40%', lineHeight: 1.2 }}>Loc</span>
                                    <span style={{ fontSize: `${3.2 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', display: 'flex', alignItems: 'center', height: '60%', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', lineHeight: 1.2 }}>{item.location || 'N/A'}</span>
                                </div>
                            </div>
                        </div>
            ...
            <div id={`${idPrefix}printable-label-content`} style={{...containerStyle, flexDirection: 'column', padding: `${2.5 * baseScale}mm`, gap: `${1.5 * baseScale}mm` }} className={isHighContrast ? 'high-contrast-mode' : ''}>
                ...
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: `${3 * baseScale}mm` }}>
                    ...
                    <div style={{ flex: 1, overflow: 'hidden' }}>
                        <p style={{ fontSize: `${4 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', lineHeight: 1.2 }}>{item.name}</p>
                        <p style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, margin: `${0.5 * baseScale}mm 0`, lineHeight: 1.2 }}>{item.category}</p>
                        <p style={{ fontSize: `${2.2 * baseScale}mm`, fontWeight: 900, margin: 0, fontFamily: 'monospace', wordBreak: 'break-all', lineHeight: 1.2 }}>{item.id}</p>
                    </div>
                </div>
                ...
                <div style={{ flex: 1, padding: `${5 * baseScale}mm`, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ flex: 1 }}>
                        ...
                        <div style={{ marginTop: `${3 * baseScale}mm`, display: 'flex', gap: `${3 * baseScale}mm` }}>
                            <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>{item.category}</span>
                            <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>•</span>
                            <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, textTransform: 'uppercase', lineHeight: 1.2 }}>{item.location || 'N/A'}</span>
                        </div>
                    </div>
        ...
        return (
            <div id={`${idPrefix}printable-label-content`} style={{...containerStyle, flexDirection: 'row', alignItems: 'center', padding: `0 ${4 * baseScale}mm`, gap: `${4 * baseScale}mm` }} className={isHighContrast ? 'high-contrast-mode' : ''}>
                ...
                <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <p style={{ fontSize: `${4 * baseScale}mm`, fontWeight: 900, margin: 0, textTransform: 'uppercase', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', lineHeight: 1.2 }}>{item.name}</p>
                    <div style={{ display: 'flex', gap: `${3 * baseScale}mm`, alignItems: 'center', marginTop: `${0.5 * baseScale}mm` }}>
                        <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, fontFamily: 'monospace', lineHeight: 1.2 }}>{item.id}</span>
                        <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, lineHeight: 1.2 }}>|</span>
                        <span style={{ fontSize: `${3 * baseScale}mm`, fontWeight: 900, lineHeight: 1.2 }}>{item.category}</span>
                    </div>
                </div>
                    ...
                    <header className="p-8 border-b dark:border-slate-800 flex flex-wrap justify-between items-center bg-white dark:bg-slate-900 gap-6">
                        ...
                        <div className="flex gap-4">
                            <div className="flex flex-col gap-1">
                                ...
                                <select value={selectedTemplate} onChange={e => setSelectedTemplate(e.target.value as LabelTemplate)} className="p-2 text-xs font-bold border rounded-lg dark:bg-slate-700">
